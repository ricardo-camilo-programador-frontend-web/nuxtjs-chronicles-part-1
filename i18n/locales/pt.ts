export default {
  ...
  cart: {
    ...
    subtitle: '{count} itens no seu carrinho',
    empty: 'Seu carrinho está vazio',
    emptyMessage: 'Parece que você ainda não adicionou nenhum item.',
    ...
    shippingStandard: 'Envio Padrão',
    shippingStandardDays: '5-7 dias úteis',
    shippingExpress: 'Envio Expresso',
    shippingExpressDays: '2-3 dias úteis',
    shippingPickup: 'Retirar na Loja',
    shippingPickupDays: 'Disponível em 24 horas',
    coupon: {
      title: 'Cupom de Desconto',
      placeholder: 'Digite o cupom',
      apply: 'Aplicar',
      remove: 'Remover',
      enterCode: 'Por favor, digite um cupom',
      invalid: 'Cupom inválido',
      applied: 'Cupom aplicado com sucesso!',
      minOrder: 'Valor mínimo do pedido não atingido',
    },
  },
  menu: {
    links: {
  ...
  products: {
    ...
    leatherDogCollar: 'Coleira de Couro para Cachorro',
    dogCollarAltText: 'Coleira de Couro Premium para Cachorro',
    catScratchingPost: 'Arranhador para Gatos',
    scratchingPostAltText: 'Arranhador para Gatos com Plataforma',
    birdCageDeluxe: 'Gaiola Luxo para Pássaros',
    birdCageAltText: 'Gaiola Luxo para Pássaros com Acessórios',
    hamsterHabitat: 'Habitat para Hamster',
    hamsterHabitatAltText: 'Kit Completo de Habitat para Hamster',
    fishTankFilter: 'Filtro para Aquário',
    fishFilterAltText: 'Filtro de Alto Desempenho para Aquário',
    dogGroomingKit: 'Kit de Tosa para Cachorro',
    groomingKitAltText: 'Kit Profissional de Tosa para Cachorro',
    catLitterBox: 'Caixa de Areia para Gatos',
    litterBoxAltText: 'Caixa de Areia Coberta para Gatos',
  },
  bestSellingProducts: {
  ...
  checkout: {
    ...
    customerInfo: 'Informações Pessoais',
    firstName: 'Nome',
    lastName: 'Sobrenome',
    email: 'E-mail',
    phone: 'Telefone',
    ...
    confirmationEmail: 'Um e-mail de confirmação foi enviado para o seu endereço.',
    continueShopping: 'Continuar Comprando',
    pixInfo: 'Você receberá um QR Code para completar o pagamento após confirmar o pedido.',
    boletoInfo: 'O boleto será gerado após confirmar o pedido. Prazo de pagamento: 3 dias úteis.',
  },
}
