export default {
  ...
  cart: {
    ...
    subtitle: '{count} items in your cart',
    ...
    shippingStandardDays: '5-7 business days',
    shippingExpress: 'Express Shipping',
    shippingExpressDays: '2-3 business days',
    shippingPickup: 'Store Pickup',
    shippingPickupDays: 'Available within 24 hours',
    coupon: {
      title: 'Promo Code',
      ...
      minOrder: 'Minimum order value not reached',
    },
  },
  menu: {
    links: {
  ...
  checkout: {
    ...
    continueShopping: 'Continue Shopping',
    pixInfo: 'You will receive a QR Code to complete the payment after confirming the order.',
    boletoInfo: 'The boleto will be generated after confirming the order. Payment deadline is 3 business days.',
  },
}
