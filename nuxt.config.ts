...
export default defineNuxtConfig({
      ...
      script: [
        {
          ...
          'defer': true,
          'data-id': process.env.NUXT_PUBLIC_COUNTER_API_KEY,
          'data-utcoffset': '-3',
          'async': true,
        },
      ],
  ...
  runtimeConfig: {
    public: {
      ...
      COUNTER_API_KEY: process.env.NUXT_PUBLIC_COUNTER_API_KEY,
      TREFLE_API_KEY: process.env.NUXT_PUBLIC_TREFLE_API_KEY,
